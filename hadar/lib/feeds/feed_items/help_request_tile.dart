  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Card(
        ...
        //VolunteerFeedTile(parent: this, widget: widget, formatter: formatter, now: now, context: context, tapPosition: _tapPosition),
      ),
    );
  }
...
class VolunteerFeedTile extends StatelessWidget {
  VolunteerFeedTile({
    Key key, this.helpRequest,
  }) :  super(key: key);
  ...
  @override
  Widget build(BuildContext context) {
    final DateTime now = helpRequest.date;
