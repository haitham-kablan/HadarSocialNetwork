...
class DataBaseServiceMock{
  ...
  CollectionReference verificationsRequestsCollection ;
  CollectionReference allHelpsRequestsCollection;
  CollectionReference tokens ;

  FirebaseFirestore firebaseFirestore;
  DataBaseServiceMock(this.firebaseFirestore){
   helpersCollection = firebaseFirestore.collection('HELPERS');
     ...
     inquiryCollection = firebaseFirestore.collection('Inqury');
     organizationsCollection = firebaseFirestore.collection('ORGANIZATIONS');
     ...
     verificationsRequestsCollection = firebaseFirestore.collection(verification_requests);
     allHelpsRequestsCollection = firebaseFirestore.collection('ALL_HELP_REQUESTS');
     tokens = firebaseFirestore.collection('TOKENS');
