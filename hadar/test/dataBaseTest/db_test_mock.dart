...
//             //   onPressed: (){
//             //     dataBaseServiceMock.addUserInNeedToDataBase(UserInNeed('haitham', '2233', 'no_need', Privilege.UserInNeed, '123456789'));
//             //     dataBaseServiceMock.addUserInNeedToDataBase(UserInNeed('s3ed', '2233', 'no_need', Privilege.UserInNeed, '2'));
//             //     dataBaseServiceMock.addUserInNeedToDataBase(UserInNeed('lbed', '2233', 'no_need', Privilege.UserInNeed, '3'));
//             //   },
//             // ),
//             RaisedButton(
...
//                 dataBaseServiceMock.addVolunteerToDataBase(Volunteer('hsen', 'sa', '123', false, '4', "",1,",",",",",","","","","",""));
//                 list1.add(HelpRequestType('fighting'));
//                 dataBaseServiceMock.addVolunteerToDataBase(Volunteer('lolly', 'sa', '123', false, '5', "",1,"","",",","","","","",""));
//               },
//             ),
//             RaisedButton(
...
//               onPressed: (){
//                 date = DateTime.now();
//                 dataBaseServiceMock.addHelpRequestToDataBaseForUserInNeed(HelpRequest(HelpRequestType('food'), 'lots of lots of food', date, '123456789','',Status.AVAILABLE,""));
//                 dataBaseServiceMock.addHelpRequestToDataBaseForUserInNeed(HelpRequest(HelpRequestType('food'), 'lots of lots of food but more', DateTime.now(), '123456789','',Status.AVAILABLE,""));
//                 dataBaseServiceMock.addHelpRequestToDataBaseForUserInNeed(HelpRequest(HelpRequestType('money'), 'lots of lots of money', date, '2','',Status.AVAILABLE,""));
//                 dataBaseServiceMock.addHelpRequestToDataBaseForUserInNeed(HelpRequest(HelpRequestType('fighting'), 'lots of lots of fights', date, '3','',Status.AVAILABLE,""));
//
//               },
//             ),
//             RaisedButton(
...
//                 list1.add(HelpRequestType('food'));
//                 list1.add(HelpRequestType('money'));
//                 dataBaseServiceMock.assignHelpRequestForVolunteer(Volunteer('hsen', 'sa', '123', false, '4', "",1,",",",",",","","","","",""), HelpRequest(HelpRequestType('food'), 'lots of lots of food', date, '123456789','',Status.AVAILABLE,""));
//                 dataBaseServiceMock.assignHelpRequestForVolunteer(Volunteer('lolly', 'sa', '123', false, '5', "",1,",",",",",","","","","",""), HelpRequest(HelpRequestType('money'), 'lots of lots of money',date, '2','',Status.AVAILABLE,""));
//
//
//               },
//             ),
...
//       value: dataBaseServiceMock.getAll_waiting_Requests(),
//       child: Scaffold(
